        ...
        <header class="bg-slate-900 text-white">
            ...
            <nav class="border-t border-slate-700">
                <div class="mx-auto flex max-w-7xl flex-wrap gap-2 px-4 py-3 text-sm">
                    ...
                    <a href="{{ route('admin.terms.edit') }}" class="rounded px-3 py-1 {{ request()->routeIs('admin.terms.*') ? 'bg-slate-700 text-white' : 'text-slate-200 hover:bg-slate-700' }}">Terms Page</a>
