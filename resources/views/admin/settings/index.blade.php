    ...
    <div class="rounded-lg bg-white p-6 shadow">
        <form method="POST" action="{{ route('admin.settings.update') }}" class="space-y-6">
            ...
            <div class="rounded border border-slate-200 p-4">
                ...
                <p class="text-sm text-slate-600">Use keys like: <code>company_phone</code>, <code>company_email</code>,
                    <code>company_address</code>, <code>facebook_url</code>, <code>instagram_url</code>,
                    <code>linkedin_url</code>, <code>youtube_url</code>, <code>tiktok_url</code>,<code>x_url</code>, <code>yelp_url</code>.</p>
            </div>
            ...
            <div class="rounded border border-slate-200 p-4">
                ...
                <div class="grid gap-3 md:grid-cols-2">
                    <input type="text" name="new_key" placeholder="key (e.g. company_phone)"
            ...
            <button type="submit" class="rounded bg-orange-500 px-4 py-2 font-medium text-white hover:bg-orange-600">Save
                Settings</button>
        </form>
    </div>
@endsection
